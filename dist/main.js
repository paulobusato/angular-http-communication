...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getAllBooks = function () {
        ...
        return this.http.get('/api/books').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return _this.handleHttpError(err); }));
    };
    ...
    DataService.prototype.getOldBookById = function (id) {
        return this.http.get("/api/books/" + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (b) { return ({
            bookTitle: b.title,
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataService.getAllBooks().subscribe(function (data) { return _this.allBooks = data; }, function (err) { return console.log(err.friendlyMessage); }, function () { return console.log('All done getting books.'); });
    ...
    DashboardComponent.prototype.deleteBook = function (bookID) {
        var _this = this;
        this.dataService.deleteBook(bookID).subscribe(function () {
...
var EditBookComponent = /** @class */ (function () {
    ...
    EditBookComponent.prototype.saveChanges = function () {
        var _this = this;
        this.dataService.updateBook(this.selectedBook).subscribe(function () { return console.log(_this.selectedBook.title + " updates successfully"); }, console.log);
    };
...
module.exports = __webpack_require__(/*! C:\Users\paulo\Documents\Desenvolvimento\Pluralsight\angular-http-communication\booktracker\src\main.ts */"./src/main.ts");
